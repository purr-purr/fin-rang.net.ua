		...
		<section className={s.container}>
			<article className={s.info}>
				...
				<p className={s.infoDesc}>
					{`Місія ТОВ "ФК "ФІН-РАНГ" - забезпечити наших клієнтів доступом до різноманітних фінансових рішень, що відповідають їхнім потребам та сприяють їхньому успіху.`}
				</p>
			</article>
