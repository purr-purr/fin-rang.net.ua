...
export const APP_LINK: string = 'https://fin-rang.net.ua/';
export const COMPANY_NAME: string[] = ['TOB ФК', '"ФІН-РАНГ"'];
export const COMPANY_FULL_NAME: string = `${COMPANY_NAME[0]} ${COMPANY_NAME[1]}`;
export const COMPANY_CATCHPHRASE: string =
	'Наша місія - надати вам фінансову підтримку та поради, щоб ви могли планувати сьогодні для кращого завтра.';
